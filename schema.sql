...
-- Date: 2025-12-08
-- 
-- This file contains the COMPLETE database definition for PraxChat.
-- It consolidates all migrations into a single, runnable schema.
--
-- ⚠️  IMPORTANT: For FRESH Supabase projects only!
--     Do NOT run on existing databases with data (contains DROP statements).
--
-- SECTIONS:
